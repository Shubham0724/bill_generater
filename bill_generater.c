...
int main()
{
    ...
    ptr2 = fopen("generate_bill.txt", "w");
    char str [200];
    fgets(str, 200, ptr);
    ...
    char * newStr;
    newStr = replaceWord(str, "{{item}}", "Nike OG Shoe");
    newStr = replaceWord(newStr, "{{outlet}}", "Nike Store");
    newStr = replaceWord(newStr, "{{name}}", "Shubham");
